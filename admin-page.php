...
?>
        ...
        <body>
            ...
            <div class="container">
                <div class="row">
                    <table id="usertable" class="table table-striped table-light justify-content-center align-items-center" style="width:100%">
                            ...
                            <tbody class="">
                                ...
                                ?>
                                    <tr class="">
                                        ...
                                        ?>
                                            <td>
                                                <a href="./services/delete-service.php?id=<?php echo $row['id'] ?>" class="btn btn-danger">Deletar</a>
                                            </td>
                                        <?php
                                        } else {
                                        ?>
                                            <td>
                                                <a href="./services/reactive-service.php?id=<?php echo $row['id'] ?>" class="btn btn-success">Reativar</a>
                                            </td>
                                        <?php
                                        }
                                        ?>
