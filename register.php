...
<body>
    <main>
        <?php
        if (isset($_GET['failedRegister']) && $_GET['failedRegister'] == "true") {
                    ...
                    <div class="card-text mb-4 mt-4">
                        ...
                        <form method="post" action="./services/register-service.php" class="login-form">
                            ...
                            <div class="form-group my-2">
                                ...
                                <input type="text" class="form-control form-control-sm form-text" id="userName" name="username" required autofocus>

                            </div>

                            <div class="form-group my-2">
                                <label for="emailAddress" class="mb-2">Endereço de email</label>
                                <input type="email" class="form-control form-control-sm form-text" id="emailAddress" name="email" required>

                            </div>

                            <div class="form-group my-2" class="mb-2">
                                <label for="password">Senha</label>
                                <input type="password" class="form-control form-control-sm form-text" id="password" name="pass" required>
                            </div>

                            <div class="d-grid gap-2">
                                <button type="submit" class="btn btn-primary mb-4 mt-4 btn-forms" type="button">Registrar</button>
                            </div>
